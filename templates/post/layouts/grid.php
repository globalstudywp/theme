...
$per_row  = ( ! empty( $settings['globalstudy-posts-per-row'] ) ) ? $settings['globalstudy-posts-per-row'] : '';
?>
	...
	<div class="news_item-item column-grid-<?php echo esc_attr( $per_row ); ?>">
		<div class="news_item-content">
			...
			<div class="news_item-content-info">
				...
				<a href="<?php the_permalink(); ?>" class="globalstudy-widget-news_item__btn">
					<?php echo esc_html__( 'Learn more', 'globalstudy' ); ?>
...
<?php
globalstudy_posts_pages_pagination( 'posts_pages_pagination' );
wp_reset_postdata();
