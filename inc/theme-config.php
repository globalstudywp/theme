...
function globalstudy_get_demo_name() {
	$demo_name = get_option( 'stm_demo_name', 'main_demo' );

	return $demo_name;
}

function globalstudy_color_styles() {
...
function globalstudy_theme_fonts() {
	...
	$subsets = apply_filters( 'globalstudy_google_fonts_subset', 'latin,latin-ext' );
...
add_action( 'init', 'globalstudy_theme_fonts' );
